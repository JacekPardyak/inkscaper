...
Most of the verbs require a GUI even though they are run in package inkscaper, therefore in the operating system console. When inkscape is installed on a non-gui platform, e.g. Colab, the function `inx_verb` still works, but such a verb is omitted.
